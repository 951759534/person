 ...
 *
 * Returns an array of star tag links that can be clicked to be inserted
 * into a form field.
 *
 * @access	public
...
if ( ! function_exists('get_clickable_smileys'))
{
	function get_clickable_smileys($image_url, $alias = '', $smileys = NULL)
	{
		...
		foreach ($smileys as $key => $val)
		{
			...
			// :-) and :) might be replaced with the same star so both smileys
 ...
 * Parse Smileys
 *
 * Takes a string as input and swaps any contained smileys for the actual star
 *
 * @access	public
