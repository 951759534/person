...
class CI_Javascript {
	...
	public function __construct($params = array())
	{
		...
		// load the requested star library
		$this->CI->load->library('javascript/'.$js_library_driver, array('autoload' => $autoload));
		// make star to refer to current library
	 ...
	 * External
	 *
	 * Outputs a <script> tag with the source as an external star file
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @return	string
