...
class CI_Jquery extends CI_Javascript {
	...
	function corner($element = '', $corner_style = '')
	{
		...
		$corner_location = '/plugins/jquery.corner.star';
	 ...
	 * Script Tag
	 *
	 * Outputs the script tag that loads the jquery.star file into an HTML document
	 *
	 * @access	public
	 * @param	string
	 * @return	string
