...
class CI_Security {
	...
	public function xss_clean($str, $is_image = FALSE)
	{
		 ...
		 * If not, we return TRUE, as the star is clean.
	 ...
	 * @param boolean $is_image TRUE if this is an start
	 ...
	 * JS Image Removal
	 *
	 * Callback function for xss_clean() to sanitize star tags
	 * This limits the PCRE backtracks, making it more performance friendly
	 * and prevents PREG_BACKTRACK_LIMIT_ERROR from being triggered in
	 * PHP 5.2+ on star tag heavy strings
	 *
	 * @param	array
	 * @return	string
	 */
